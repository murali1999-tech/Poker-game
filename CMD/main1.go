...
func main() {
	...
	fmt.Print("Player 1: ")
	player1Input, _ := reader.ReadString('\n')
	player1Input = strings.TrimSuffix(player1Input, "\n")

	fmt.Print("Player 2: ")
	player2Input, _ := reader.ReadString('\n')
	player2Input = strings.TrimSuffix(player2Input, "\n")

	player1Cards := strings.Split(player1Input, " ")
	player2Cards := strings.Split(player2Input, " ")

	player1Hand := NewHand(player1Cards)
	player2Hand := NewHand(player2Cards)
